...
namespace WebApplication18.Controllers
{
    public class JobSeekerController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Register(JobSRegister obj)
        {
            /*try
            {*/
            ...
            #endregion
            return RedirectToAction("JSRegistration");
            /*}
            catch {Exception e }
            return View();*/
        }
        ...
        {
            var IsCheck = db.JobSRegisters.Where(email => email.Email == eMail).FirstOrDefault();
            return IsCheck != null;
        }
        #endregion
        ...
        {
            var GenarateUserVerificationLink = "/JobSeeker/UserVerification/" + activationCode;
        ...
        public ActionResult UserVerification(string id)
        {
            ...
            var IsVerify = db.JobSRegisters.Where(u => u.ActivationCode == new Guid(id)).FirstOrDefault();
        ...
        public ActionResult Login(UserLogin logUsr, string ReturnUrl = "")
        {
            ...
            {
                var v = db.JobSRegisters.Where(a => a.Email == logUsr.EmailId && a.EmailVerification == true).FirstOrDefault();
                if (v != null)
                {
                    ...
                    if (string.Compare(encryptPassword.textToEncrypt(logUsr.Password), v.Password) == 0)
                    {
                        ...
                        {
                            return RedirectToAction( "Register", "JobSeeker");
                        }
                    }
                    else
                    {
        ...
        public ActionResult ForgetPassword(ForgetPassword pass)
        {
            ...
            var objUsr = db.JobSRegisters.Where(x => x.Email == pass.EmailId).FirstOrDefault();
        ...
        {
            var GenerateUserVerificationLink = "/JobSeeker/ChangePassword/" + activationCode;
